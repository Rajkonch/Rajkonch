...
Button getotpbutton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.entermobilnumberone);
        enternumber=findViewById(R.id.imput_mobile_number);
            ...
            public void onClick(View v) {
                if(!enternumber.getText().toString().trim().isEmpty()){
                    if((enternumber.getText().toString().trim()).length()==10){
                        ...
                        PhoneAuthProvider.getInstance().verifyPhoneNumber("+91" + enternumber.getText()
                                        .toString(), 60, TimeUnit.SECONDS, entermobilenumberone.this,
                                new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
                                    ...
                                    public void onVerificationFailed(@NonNull FirebaseException e) {
                                        progressBar.setVisibility(View.GONE);
                                        getotpbutton.setVisibility(View.VISIBLE);
                                        Toast.makeText(entermobilenumberone.this, "Error Please check Internet "+e.getMessage(), Toast.LENGTH_SHORT).show();
                                    }
